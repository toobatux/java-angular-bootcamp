...
export class CustomerListPageComponent {
  // TODO: inject CustomerApiService; replace SEED_CUSTOMERS with api.getAll()
  ...
  loadCustomers(): void {
    ...
    this.error.set(null);
    // TODO: api.getAll() + catchError; remove this seed fallback
    this.customers.set([...SEED_CUSTOMERS]);
    this.loading.set(false);
  }

  createMaya(): void {
    // TODO: api.create({ id: 'CUS-1003', name: 'Maya Chen', ... }) then reload
    this.error.set('TODO: POST CUS-1003 Maya Chen via CustomerApiService');
  }
