# Lab 32: Resilience4j for CRM Outbound Calls — Northstar Account Profile — macOS
...
**Other OS:** [Windows guide](LAB-32-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab32-crm` |
...
Complete every step in **[LAB-32-GUIDE.md](LAB-32-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
