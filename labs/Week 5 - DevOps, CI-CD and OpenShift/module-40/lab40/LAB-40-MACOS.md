...
Copy Lab 39 into `~/java-bootcamp/examples/lab40-crm` and use isolated database **`crm_lab40`**. First NVD populate without an API key can take ~36 minutes; later runs reuse `dependency-check-data/`. Do **not** lower `failBuildOnCVSS` to greenwash.
