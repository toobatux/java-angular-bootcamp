# Lab 12: Coding Standards and Refactoring — Northstar CRM Cleanup — macOS
...
**Other OS:** [Windows guide](LAB-12-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab12-crm` |
...
Complete every step in **[LAB-12-GUIDE.md](LAB-12-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
