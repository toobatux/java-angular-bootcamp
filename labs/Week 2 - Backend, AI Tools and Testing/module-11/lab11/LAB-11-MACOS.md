# Lab 11: GitHub Copilot for Testing and Refactoring — Northstar CRM — macOS
...
**Other OS:** [Windows guide](LAB-11-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab11-crm` |
...
Complete every step in **[LAB-11-GUIDE.md](LAB-11-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
