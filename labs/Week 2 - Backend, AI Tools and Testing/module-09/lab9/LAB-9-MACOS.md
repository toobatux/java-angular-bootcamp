# Lab 9: Maven Build and Dependencies — Northstar CRM Build Lab — macOS
...
**Other OS:** [Windows guide](LAB-9-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab9-crm` |
...
Complete every step in **[LAB-9-GUIDE.md](LAB-9-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
