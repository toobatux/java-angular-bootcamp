# Lab 14: DTOs and Validation — Northstar CRM API Contract Boundary — macOS
...
**Other OS:** [Windows guide](LAB-14-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab14-crm` |
...
Complete every step in **[LAB-14-GUIDE.md](LAB-14-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
