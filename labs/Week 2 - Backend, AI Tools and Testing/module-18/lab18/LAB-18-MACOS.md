# Lab 18: Mockito and Mocking with AI Assistance — Northstar CRM Isolation Tests — macOS
...
**Other OS:** [Windows guide](LAB-18-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab18-crm` |
...
Complete every step in **[LAB-18-GUIDE.md](LAB-18-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
