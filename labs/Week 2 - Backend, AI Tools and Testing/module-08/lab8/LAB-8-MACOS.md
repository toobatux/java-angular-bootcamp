# Lab 8: Project Structure and Organization — Northstar CRM Skeleton — macOS
...
**Other OS:** [Windows guide](LAB-8-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab8-crm` |
...
Complete every step in **[LAB-8-GUIDE.md](LAB-8-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
