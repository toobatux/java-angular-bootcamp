# Lab 20: Structured Logging — Northstar CRM Traceable Operations — macOS
...
**Other OS:** [Windows guide](LAB-20-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab20-crm` |
...
Complete every step in **[LAB-20-GUIDE.md](LAB-20-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
