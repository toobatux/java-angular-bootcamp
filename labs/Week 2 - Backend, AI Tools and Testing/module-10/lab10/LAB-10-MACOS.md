# Lab 10: GitHub Copilot Fundamentals for Java Developers — Northstar CRM — macOS
...
**Other OS:** [Windows guide](LAB-10-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab10-crm` |
...
Complete every step in **[LAB-10-GUIDE.md](LAB-10-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
