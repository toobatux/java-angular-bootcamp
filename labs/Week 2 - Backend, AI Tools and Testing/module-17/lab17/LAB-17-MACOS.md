# Lab 17: JUnit Testing with AI Assistance — Northstar CRM Service Tests — macOS
...
**Other OS:** [Windows guide](LAB-17-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab17-crm` |
...
Complete every step in **[LAB-17-GUIDE.md](LAB-17-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
