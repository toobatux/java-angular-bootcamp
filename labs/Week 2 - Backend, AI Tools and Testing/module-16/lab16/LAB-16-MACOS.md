# Lab 16: API Exception Handling — Northstar CRM Error Model — macOS
...
**Other OS:** [Windows guide](LAB-16-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab16-crm` |
...
Complete every step in **[LAB-16-GUIDE.md](LAB-16-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
