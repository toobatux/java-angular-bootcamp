# Lab 21: Observability and Monitoring — Northstar CRM Actuator & Metrics — macOS
...
**Other OS:** [Windows guide](LAB-21-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| This lab project | `~/java-bootcamp/examples/lab21-crm` |
...
Complete every step in **[LAB-21-GUIDE.md](LAB-21-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
